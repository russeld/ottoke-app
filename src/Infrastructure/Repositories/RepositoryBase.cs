...
public abstract class RepositoryBase<T> : IRepositoryBase<T> where T : class
{
    ...
    protected ISpecificationEvaluator ConcreteSpecificationEvaluator { get; set; }
    ...
    {
        DbContext = dbContext;
        ConcreteSpecificationEvaluator = specificationEvaluator;
    }
    ...
    {
        return ConcreteSpecificationEvaluator.GetQuery(DbContext.Set<T>().AsQueryable(), specification, evaluateCriteriaOnly);
    }
    ...
    {
        return ConcreteSpecificationEvaluator.GetQuery(DbContext.Set<T>().AsQueryable(), specification);
    }
}
